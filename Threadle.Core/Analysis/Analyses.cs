...
namespace Threadle.Core.Analysis
{
    ...
    public static class Analyses
    {
        ...
        /// method (CommunityDetectionLouvain, CommunityDetectionLeiden,
        /// CommunityDetectionLabelPropagation, CommunityDetectionLPAm, and future ones). Rejects
        /// 2-mode layers with a "project first" message, matching Coreness/ClusteringCoefficient.
        /// </summary>
