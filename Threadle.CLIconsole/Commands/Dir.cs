...
{
    /// <summary>
    /// Class representing the 'dir' CLI command.
    /// </summary>
    public class Dir : ICommand
    {
        ...
        /// </summary>
        public string Syntax => "dir(*path = [str])";
        ...
        {
            string? path = command.GetArgument("path", "arg0");
            var result = FileManager.GetDirectoryListing(path);
            if (!result.Success)
