...
namespace Threadle.CLIconsole.Commands
{
    ...
    public class GetNodeAlters : ICommand
    {
        ...
        /// </summary>
        public string Syntax => "[array:uint] = getnodealters(network = [var:network], nodeid = [uint], *layernames = [semicolon-separated layer names], *direction = ['both'(default),'in','out'], *unique = [false,true(default)])";
