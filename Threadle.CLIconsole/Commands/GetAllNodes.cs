...
{
    /// <summary>
    /// Class representing the 'getallnodes' CLI command.
    /// </summary>
    public class GetAllNodes : ICommand
    {
        ...
        /// </summary>
        public string Syntax => "[array:str] = getallnodes(structure = [var:structure], *offset = [int(default:0)], *limit = [int(default:1000])";
