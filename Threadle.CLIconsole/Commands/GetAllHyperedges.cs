...
namespace Threadle.CLIconsole.Commands
{
    ...
    public class GetAllHyperedges : ICommand
    {
        ...
        /// </summary>
        public string Description => "Returns a JSON-ready array/vector of the hyperedge names that exist in the specified layer and network. Will return maximum 1000 by default, but this can be changed with the 'limit' argument. Starts with the first one (index zero) by default, but this can be adjusted with 'offset'. Thus, if there are more than 1000 hyperedges, all can be obtained either by using 'offset' for pagination and/or increasing the 'limit'.";
